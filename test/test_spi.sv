...
class driver extends uvm_driver #(transaction);
    ...
    task reset_dut();
        ...
        vif.rst <= 1'b0; // explicitly bring it down!
    endtask
    ...
    task drive();
        ...
        forever begin
            ...
            if(tr.op == rstdut) begin
                ...
                @(posedge vif.done);
                @(negedge vif.done); // wait for SPI FSM to finish transaction properly
            end
...
class sco extends uvm_scoreboard;
    ...
    bit [7:0] arr[32] = '{default:0}; // Changed to 8-bit to match din/dout bus size
    bit [7:0] data_rd = 0;
